  ...
  return (
    <div className="basic-popup item-added-to-cart-popup">
      ...
      <div className="item-added-to-cart-popup__buttons-wrapper">
        <button className="item-added-to-cart-popup__go-to-cart button button--orange" type="button">Перейти в корзину</button>
        <button className="item-added-to-cart-popup__continue button button--white" type="button">Продолжить покупки</button>
      </div>
    </div>
  );
};
